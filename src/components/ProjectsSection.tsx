      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-3 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-500/10 border border-brand-500/20 text-xs font-mono text-brand-600 dark:text-brand-400">
          ...
          <div className="text-xs font-mono text-gray-500 dark:text-gray-400">
            Mostrando <span className="text-gray-900 dark:text-white font-bold">{filteredProjects.length}</span> proyectos reales
          </div>
        </div>
            ...
            >
              ...
              <span
                className={`text-[10px] px-1.5 py-0.2 rounded-full ${
                  activeCategory === cat.id ? "bg-black/20 text-white" : "bg-black/5 dark:bg-white/10 text-gray-600 dark:text-gray-400"
                }`}
              >
                {cat.count}
              </span>
