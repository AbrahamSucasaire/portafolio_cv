    ...
    <header className="fixed top-0 inset-x-0 z-50 transition-all duration-300 pointer-events-none">
      ...
      >
        <div className="flex items-center justify-between pointer-events-auto">
          ...
          <a
            href="#"
            className="group flex items-center gap-3 p-1.5 pr-4 rounded-full bg-canvas-950/80 backdrop-blur-xl border border-white/10 hover:border-brand-500/40 shadow-xl transition-all duration-300 hover:scale-103"
          >
            <div className="relative w-9 h-9 rounded-full overflow-hidden border border-white/20 shadow-md">
              <img
                src={PERSONAL_INFO.profileImage}
                alt={PERSONAL_INFO.displayName}
                className="w-full h-full object-cover object-center group-hover:scale-110 transition-transform duration-300"
              />
              <span className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-emerald-500 border-2 border-canvas-950 animate-pulse" />
            </div>
          ...
          <nav className="hidden md:flex items-center p-1.5 rounded-full bg-canvas-950/85 backdrop-blur-2xl border border-white/15 shadow-2xl shadow-black/60 gap-1">
            {navLinks.map((link) => {
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            <a
              href="#perfil"
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold bg-canvas-950/80 backdrop-blur-xl border border-white/15 text-gray-200 hover:text-white hover:border-white/30 transition-all hover:scale-105 shadow-lg"
            >
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-full bg-canvas-950/90 backdrop-blur-md border border-white/15 text-gray-200 hover:text-white shadow-lg focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden px-4 pt-2 pb-6 pointer-events-auto animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="p-5 rounded-3xl bg-canvas-950/95 backdrop-blur-2xl border border-white/15 shadow-2xl space-y-3">
            <div className="text-[10px] font-mono text-gray-400 uppercase tracking-widest px-2 pb-1 border-b border-white/5">
                  ...
                  <a
                    ...
                    className={`flex items-center justify-between px-4 py-3 rounded-2xl text-xs font-medium transition-all ${
                      isActive
                        ...
                        : "bg-white/[0.03] text-gray-300 hover:text-white hover:bg-white/[0.08]"
                    }`}
                  >
